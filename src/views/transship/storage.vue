<template>
  <div class="post-container">
    ...
    <el-table
      ...
      style="width: 100%"
      height="75vh">
      <el-table-column label="货品编号" prop="item1"></el-table-column>
      <el-table-column label="用户编号" prop="item2"></el-table-column>
      <el-table-column label="尺寸" prop="item3"></el-table-column>
      <el-table-column label="重量" prop="item4"></el-table-column>
      <el-table-column label="图片" prop="item5"></el-table-column>
      <el-table-column label="入库时间" prop="item6"></el-table-column>
