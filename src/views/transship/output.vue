<template>
  <div class="post-container">
    ...
    <el-table
      ...
      style="width: 100%"
      height="75vh">
      <el-table-column label="出库单号" prop="item1"></el-table-column>
      <el-table-column label="货品单号" prop="item2"></el-table-column>
      <el-table-column label="用户编号" prop="item3"></el-table-column>
      <el-table-column label="出库种类" prop="item4"></el-table-column>
      <el-table-column label="收货地址" prop="item5"></el-table-column>
      <el-table-column label="出库时间" prop="item6"></el-table-column>
      <el-table-column label="状态" prop="item7">
  ...
  export default {
    ...
    data () {
      return {
        ...
        loading: true,
        tableData: [
          {item1: 12312312,item2: 12312312,item3: 12312312,item4: 12312312,item5: 12312312,item6: 1,item7: 1}
        ],
        tags: null,
